...
public class ExceptionConfiguration extends ResponseEntityExceptionHandler{
	...
	// Default exception (Xu ly all exception)
	...
	// Not found url handler (Khong tim thay trinh xu lys url)
		@Override
		...
		// missing parameter (Thieu tham so yeu cau cau cua method)
		@Override
		...
		// wrong parameter type (sai kieu du lieu truyen vao)
